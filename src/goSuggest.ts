				...
				try {
					...
					if (results[1]) {
						for (let suggest of results[1]) {
							...
							if ((conf.get('useCodeSnippetsOnFunctionSuggestWithoutType') || conf.get('useCodeSnippetsOnFunctionSuggest')) && suggest.class === 'func') {
								...
								//TODO split on paramSnippets afterward?
